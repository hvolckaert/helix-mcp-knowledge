...
## 2. Clean installation of v1.31.2
...
```bash
./scripts/install-linux.sh --version 1.31.2
```
...
```bash
export HELIX_KNOWLEDGE_VERSION="1.31.2"
...
```bash
~/.local/share/helix-mcp-knowledge/runtime/1.31.2/venv/bin/helix-mcp-knowledge \
