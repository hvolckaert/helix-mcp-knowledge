...
## 2. Clean installation of v1.28.1
...
```bash
export HELIX_KNOWLEDGE_VERSION="1.28.1"
...
```bash
~/.local/share/helix-mcp-knowledge/runtime/1.28.1/venv/bin/helix-mcp-knowledge \
...
Use `--version 1.28.1` to pin a release. The updater requires an authenticated
