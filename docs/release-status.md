...
- native Windows supervisor liveness detection and external termination of both
  supervisor and worker process trees, preventing stale descendants from retaining
