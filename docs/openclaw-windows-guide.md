...
## 3. Clean installation of v1.31.1
...
.\scripts\install-windows.ps1 `
  -Version 1.31.1 `
  -WheelPath C:\Temp\helix_mcp_knowledge-1.31.1-py3-none-any.whl `
...
```powershell
& "$env:LOCALAPPDATA\helix-mcp-knowledge\runtime\1.31.1\venv\Scripts\helix-mcp-knowledge.exe" `
...
Use `--version 1.31.1` to pin a release. The updater requires `gh attestation
...
Versions 1.0.x do not include `update`. Install v1.31.1 once in a parallel
