...
## 3. Clean installation of v1.31.6
...
.\scripts\install-windows.ps1 `
  -Version 1.31.6 `
  -WheelPath C:\Temp\helix_mcp_knowledge-1.31.6-py3-none-any.whl `
...
```powershell
& "$env:LOCALAPPDATA\helix-mcp-knowledge\runtime\1.31.6\venv\Scripts\helix-mcp-knowledge.exe" `
...
Use `--version 1.31.6` to pin a release. The updater installs or reuses the
...
Versions 1.0.x do not include `update`. Install v1.31.6 once in a parallel
