...
## 3. Clean installation of v1.30.0
...
.\scripts\install-windows.ps1 `
  -Version 1.30.0 `
  -WheelPath C:\Temp\helix_mcp_knowledge-1.30.0-py3-none-any.whl `
...
```powershell
& "$env:LOCALAPPDATA\helix-mcp-knowledge\runtime\1.30.0\venv\Scripts\helix-mcp-knowledge.exe" `
...
Use `--version 1.30.0` to pin a release. The updater requires authenticated
