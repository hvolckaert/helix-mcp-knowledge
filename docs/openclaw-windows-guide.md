...
## 3. Clean installation of v1.31.0
...
.\scripts\install-windows.ps1 `
  -Version 1.31.0 `
  -WheelPath C:\Temp\helix_mcp_knowledge-1.31.0-py3-none-any.whl `
...
```powershell
& "$env:LOCALAPPDATA\helix-mcp-knowledge\runtime\1.31.0\venv\Scripts\helix-mcp-knowledge.exe" `
...
Versions 1.0.x do not include `update`. Install v1.31.0 once in a parallel
