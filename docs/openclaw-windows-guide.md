...
## 3. Clean installation of v1.31.8
...
```powershell
.\scripts\install-windows.ps1 -Version 1.31.8
```
...
.\scripts\install-windows.ps1 `
  -Version 1.31.8 `
  -WheelPath C:\Temp\helix_mcp_knowledge-1.31.8-py3-none-any.whl `
...
```powershell
& "$env:LOCALAPPDATA\helix-mcp-knowledge\runtime\1.31.8\venv\Scripts\helix-mcp-knowledge.exe" `
...
Use `--version 1.31.8` to pin a release. The updater installs or reuses the
...
Versions 1.0.x do not include `update`. Install v1.31.8 once in a parallel
